...
* [4.1. if Statements](https://docs.python.org/3/tutorial/controlflow.html#if-statements)* [4.2. for Statements](https://docs.python.org/3/tutorial/controlflow.html#for-statements)
...
* [Exercise: Unix Commands](/exercises/UNIX_commands.md* [HOWTO Fetch Internet Resources Using The urllib Package](https://docs.python.org/3/howto/urllib2.html)
...
* [The Markdown syntax](other_materials/markdown.md* [Unix Commands](/other_materials/unix_commands.md)
* [file object](https://docs.python.org/3/glossary.html#term-file-object)* [os — Miscellaneous operating system interfaces](https://docs.python.org/3/library/os.html* [subprocess — Subprocess management](https://docs.python.org/3.7/library/subprocess.html#module-subprocess)
